...
- [x] Installer selection model and tests
- [x] Keyboard-only TUI and non-interactive presets
- [x] Core safety guard and classification tests
- [x] Embedded development and setup Skills
- [x] GitHub MCP Bundle
- [x] Playwright MCP Bundle
- [x] Runtime extension Bundle
